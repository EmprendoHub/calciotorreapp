...
const ThreeDFlipBoxComp = ({ data, className, classNameBack }) => {
  ...
  return (
    <div className="flip-card m-4 maxlg:mx-2 maxmd:mx-1 maxsm:my-2 ">
      <div className="flip-card-front  w-[240px] maxlg:w-[200px] maxsm:w-[420px] maxxxs:w-[300px] min-h-[340px] ">
      ...
      <div className="flip-card-back w-[240px] maxlg:w-[200px] maxsm:w-[420px] maxxxs:w-[300px] min-h-[340px]  ">
